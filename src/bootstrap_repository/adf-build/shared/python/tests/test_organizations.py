...
from .stubs import organizations
...
def test_get_parent_info(cls):
    cls.client = Mock()
    cls.client.list_parents.return_value = organizations.stub_list_parents
...
def test_get_organization_info(cls):
    cls.client = Mock()
    cls.client.describe_organization.return_value = organizations.stub_describe_organization
...
def test_describe_ou_name(cls):
    cls.client = Mock()
    cls.client.describe_organizational_unit.return_value = organizations.stub_describe_organizational_unit
...
def test_build_account_path(cls):
    cls.client = Mock()
    cache = Cache()
    cls.client.list_parents.return_value = organizations.stub_list_parents_root
    cls.client.describe_organizational_unit.return_value = organizations.stub_describe_organizational_unit
