...
"""
The Cleanup Legacy Stacks Handler that is called when ADF is installed or
updated remove previous ADF stacks in the management account if these
were to exist.
"""

try:
    from cleanup_legacy_stacks import lambda_handler  # pylint: disable=unused-import
